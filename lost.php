...
alert('Login to submit lost item');
</script>";
//     echo '<script>alert("Login to post lost items")</script>'; 
...
<head>
    ...
    <title>Submit Lost Item - Lost & Found</title>
...
<body>
    ...
    <div class="row">
        <div class="col-md-6 col-md-offset-3">
            <form id="msform" action="backend/lostform.php" method="post" enctype="multipart/form-data">
                <ul id="progressbar">
                ...
                <fieldset>
                    <h2 class="fs-title">Submit Lost Property</h2>
                    <h3 class="fs-subtitle">Please be descriptive when submitting your lost property report, the more information you give us the better chance you have of retrieving your items.</h3>
                    <div class="pp">
        ...
        font-family: montserrat, arial, verdana;">Upload Image</label>
                    ...
                    <input type="text" name="Iname" id="Iname" placeholder="Item Lost" required />
                    <textarea id="des" name="dnme" placeholder="Description" maxlength="300" style=" resize: none;"></textarea>
                    <input type="text" name="fname" id="fname" placeholder="Owner name" required />
                    <input type="email" id="email" name="email" pattern="[^@]+@[^@]+\.[a-zA-Z]{2,6}" placeholder="Enter Email" />
    ...
    ;">Time</h2>
                    ...
                    <input type="button" name="previous" class="previous qq action-button-previous" value="Previous" />
                    <input type="button" name="next" class="next q action-button" value="Next" />
                </fieldset>
                ...
                <fieldset>
                    ...
                    <input type="mail" id="email1" placeholder="Enter Email" readonly />
    ...
    ;">Time</h2>
                    ...
                    <input type="button" name="previous" class="previous qqq action-button-previous" value="Previous" />
