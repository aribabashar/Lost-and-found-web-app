...
$(document).ready(function()
 {$(".sx").click(function() {
var value1 = $("#Iname").val();
var value2 = $("#des").val();
var value3 = $("#fname").val();
...
$(".des15").val(value14);
// var value7 = $("#time1").val();
// var value20 = $("#time1").val();
// $("#time1").val(value7);
// $("#time3").val(value20)
if ((value1.length<4) || (value1.length>100)){

alert('Plase fill Item name(length min:4 max:40) field');
}
else if ((value2.length<10) || (value2.length>300)) {
alert('Plase fill description(length min:10 max:300) field');

}
else if ((value3.length<4) || (value3.length>50)) {
alert('Plase fill  owner name(length min:4 max:50) field');
...
if ((value5.length<4) || (value5.length>100)){
	alert('Plase fill Location(length min:4 max:40) field');
}

else if (value6==0){
alert('Plase fill date field');
